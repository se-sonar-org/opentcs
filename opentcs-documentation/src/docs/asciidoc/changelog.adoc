...
* New features:
** Add `POST /vehicles/{NAME}/commAdapter/position` to the Web API, allowing a vehicle's position to be set (or reset) via its loopback communication adapter, as the loopback vehicle driver panel in the Kernel Control Center does.
* Bugs fixed:
