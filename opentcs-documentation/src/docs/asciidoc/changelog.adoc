...
** Add a browser-based 3D fleet map viewer (three.js) to the kernel's web API, served at
   `/webviewer3d` and showing vehicle positions moving in real time via the Server-Sent Events
   API.
* Bugs fixed:
