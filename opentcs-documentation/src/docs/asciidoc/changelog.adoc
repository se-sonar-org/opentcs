...
*** Add `POST /vehicles/{NAME}/commAdapter/position` endpoint for setting a vehicle's position as reported by its driver (e.g. for vehicles attached to the loopback communication adapter).
* Bugs fixed:
