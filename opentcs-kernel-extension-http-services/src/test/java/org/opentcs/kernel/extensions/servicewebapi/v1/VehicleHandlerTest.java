...
class VehicleHandlerTest {
  ...
  @Test
  void setCommAdapterPosition() {
    handler.putVehicleCommAdapterPosition("some-vehicle", "some-point");
  ...
  void throwOnSetCommAdapterPositionForUnknownVehicle() {
    assertThatExceptionOfType(ObjectUnknownException.class)
        .isThrownBy(
            () -> handler.putVehicleCommAdapterPosition("some-unknown-vehicle", "some-point")
        );
  }
